...
class UpdateOfferingRequest extends FormRequest
{
    ...
    {
        return $this->user()->can('update offerings');
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'slug' => ['sometimes', 'required', 'string', 'max:255', Rule::unique('offerings')->ignore($this->offering)],
            ...
            'features.*.id' => ['nullable', 'exists:offering_features,id'],
            'features.*.title' => ['required_with:features', 'string', 'max:255'],
            'features.*.description' => ['nullable', 'string'],
            'features.*.icon' => ['nullable', 'string', 'max:255'],
            
            'process_steps' => ['nullable', 'array'],
            'process_steps.*.id' => ['nullable', 'exists:offering_process_steps,id'],
            ...
            'faqs' => ['nullable', 'array'],
            'faqs.*.id' => ['nullable', 'exists:offering_faqs,id'],
            'faqs.*.question' => ['required_with:faqs', 'string', 'max:500'],
            'faqs.*.answer' => ['required_with:faqs', 'string'],
            
            'technologies' => ['nullable', 'array'],
            'technologies.*.id' => ['nullable', 'exists:offering_technologies,id'],
            ...
            'pricing_models.*.id' => ['nullable', 'exists:offering_pricing_models,id'],
