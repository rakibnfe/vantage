<template>
  <div :class="[
    ...
    <div :class="[
      ...
      <component 
        :is="iconMap[offering.icon] || Squares2X2Icon" 
    ...
    <div :class="['flex-1 p-6', viewMode === 'list' ? 'pl-0' : '']">
      ...
      <!-- Features -->
      <div v-if="offering.features?.length" class="flex flex-wrap gap-2 mb-4">
        <span 
...
const navigateToOffering = () => {
  router.push(`/offerings/${props.offering.slug}`)
}
</script>