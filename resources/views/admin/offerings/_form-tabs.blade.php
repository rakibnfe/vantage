@props(['offering' => null, 'activeTab' => 'basic'])
...
<div x-data="{ activeTab: '{{ $activeTab }}' }">
    ...
    <div>
        <div x-show="activeTab === 'basic'" x-cloak>
            @include('admin.offerings.tabs.basic', ['offering' => $offering])
        </div>
        
        <div x-show="activeTab === 'features'" x-cloak>
            @include('admin.offerings.tabs.features', ['offering' => $offering])
        </div>
        
        <div x-show="activeTab === 'process'" x-cloak>
            @include('admin.offerings.tabs.process', ['offering' => $offering])
        </div>
        
        <div x-show="activeTab === 'faqs'" x-cloak>
            @include('admin.offerings.tabs.faqs', ['offering' => $offering])
        </div>
        
        <div x-show="activeTab === 'technologies'" x-cloak>
            @include('admin.offerings.tabs.technologies', ['offering' => $offering])
        </div>
        
        <div x-show="activeTab === 'pricing'" x-cloak>
            @include('admin.offerings.tabs.pricing', ['offering' => $offering])
        </div>
        
        <div x-show="activeTab === 'projects'" x-cloak>
            @include('admin.offerings.tabs.projects', ['offering' => $offering])
        </div>
        
        <div x-show="activeTab === 'seo'" x-cloak>
            @include('admin.offerings.tabs.seo', ['offering' => $offering])
        </div>
    </div>
</div>