...
<div class="space-y-4">
    ...
    <p class="text-sm text-gray-600 dark:text-gray-400">Select projects that showcase this offering</p>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <label class="relative flex items-start p-4 bg-gray-50 dark:bg-gray-700 rounded-lg cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-600 transition border-2 hover:border-primary-500 dark:hover:border-primary-400"
            ...
            <div class="flex items-center h-5">
                <input type="checkbox" 
                       name="project_ids[]" 
                       value="{{ $project->id }}"
                       {{ $offering && $offering->projects && $offering->projects->contains($project->id) ? 'checked' : '' }}
        ...
        <div class="col-span-full text-center py-12">
            ...
            <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Create projects first to associate with this offering.</p>
