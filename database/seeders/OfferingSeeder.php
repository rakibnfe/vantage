...
use App\Models\OfferingFeature;
use App\Models\OfferingProcessStep;
use App\Models\OfferingFAQ;
use App\Models\OfferingTechnology;
...
class OfferingSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // 1. Web Development Offering
        $webDev = Offering::create([
        ...
        foreach ($features as $feature) {
            OfferingFeature::create($feature);
        }
        ...
        foreach ($processSteps as $step) {
            OfferingProcessStep::create($step);
        }
        ...
        foreach ($faqs as $faq) {
            OfferingFAQ::create($faq);
        }

        // Technologies
        $technologies = [
            // Backend
            ['offering_id' => $webDev->id, 'name' => 'Laravel 12', 'category' => 'Backend', 'icon' => 'laravel', 'url' => 'https://laravel.com', 'order' => 1, 'created_at' => now(), 'updated_at' => now()],
            ['offering_id' => $webDev->id, 'name' => 'PHP 8.3', 'category' => 'Backend', 'icon' => 'php', 'url' => 'https://php.net', 'order' => 2, 'created_at' => now(), 'updated_at' => now()],
            ['offering_id' => $webDev->id, 'name' => 'MySQL 8', 'category' => 'Database', 'icon' => 'mysql', 'url' => 'https://mysql.com', 'order' => 3, 'created_at' => now(), 'updated_at' => now()],
            ['offering_id' => $webDev->id, 'name' => 'PostgreSQL', 'category' => 'Database', 'icon' => 'postgresql', 'url' => 'https://postgresql.org', 'order' => 4, 'created_at' => now(), 'updated_at' => now()],
            ['offering_id' => $webDev->id, 'name' => 'Redis', 'category' => 'Caching', 'icon' => 'redis', 'url' => 'https://redis.io', 'order' => 5, 'created_at' => now(), 'updated_at' => now()],
            
            // Frontend
            ['offering_id' => $webDev->id, 'name' => 'Vue 3', 'category' => 'Frontend', 'icon' => 'vue', 'url' => 'https://vuejs.org', 'order' => 6, 'created_at' => now(), 'updated_at' => now()],
            ['offering_id' => $webDev->id, 'name' => 'Pinia', 'category' => 'State Management', 'icon' => 'pinia', 'url' => 'https://pinia.vuejs.org', 'order' => 7, 'created_at' => now(), 'updated_at' => now()],
            ['offering_id' => $webDev->id, 'name' => 'Tailwind CSS', 'category' => 'Styling', 'icon' => 'tailwind', 'url' => 'https://tailwindcss.com', 'order' => 8, 'created_at' => now(), 'updated_at' => now()],
            ['offering_id' => $webDev->id, 'name' => 'Alpine.js', 'category' => 'Frontend', 'icon' => 'alpine', 'url' => 'https://alpinejs.dev', 'order' => 9, 'created_at' => now(), 'updated_at' => now()],
            ['offering_id' => $webDev->id, 'name' => 'Inertia.js', 'category' => 'Full-stack', 'icon' => 'inertia', 'url' => 'https://inertiajs.com', 'order' => 10, 'created_at' => now(), 'updated_at' => now()],
            
            // DevOps
            ['offering_id' => $webDev->id, 'name' => 'Docker', 'category' => 'DevOps', 'icon' => 'docker', 'url' => 'https://docker.com', 'order' => 11, 'created_at' => now(), 'updated_at' => now()],
            ['offering_id' => $webDev->id, 'name' => 'GitHub Actions', 'category' => 'CI/CD', 'icon' => 'github', 'url' => 'https://github.com/features/actions', 'order' => 12, 'created_at' => now(), 'updated_at' => now()],
            ['offering_id' => $webDev->id, 'name' => 'AWS', 'category' => 'Cloud', 'icon' => 'aws', 'url' => 'https://aws.amazon.com', 'order' => 13, 'created_at' => now(), 'updated_at' => now()],
            ['offering_id' => $webDev->id, 'name' => 'Laravel Forge', 'category' => 'Server Management', 'icon' => 'forge', 'url' => 'https://forge.laravel.com', 'order' => 14, 'created_at' => now(), 'updated_at' => now()],
            ['offering_id' => $webDev->id, 'name' => 'Laravel Vapor', 'category' => 'Serverless', 'icon' => 'vapor', 'url' => 'https://vapor.laravel.com', 'order' => 15, 'created_at' => now(), 'updated_at' => now()],
        ];
        foreach ($technologies as $tech) {
            OfferingTechnology::create($tech);
        }
        ...
        foreach ($pricingModels as $model) {
            OfferingPricingModel::create($model);
        }

        // 2. E-commerce Development Service
        $ecommerce = Offering::create([
